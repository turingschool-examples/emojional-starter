...
var sillyReponses= ['Interesting response', 'Sounds ... good?', 'Me too.'];
...
var index2= Math.floor(Math.random() * sillyReponses.length);
var index3= Math.floor(Math.random() * cryingReponses.length);
...
function generateResponse(event){
  if (event.classList.contains('happy')){
